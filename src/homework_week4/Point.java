...
public class Point {
    ...
    // No-argument constructor, Initialize the fields to default values
    public Point() {
        this.x = 0;
        this.y = 0;
    }
    ...
    public double distance() {
        ...
        double distance1 = (x - 0) * (x - 0) + (y - 0) * (y - 0);
    ...
    public double distance(int x, int y) {
        double distance2 = (this.x - x) * (this.x - x) + (this.y - y) * (this.y - y);
        // Calculate the square root
    ...
    public double distance(Point another) {
        double distance3 = (this.x - another.getX()) * (this.x - another.getX()) + (this.y - another.getY()) * (this.y - another.getY());
        // Calculate the square root
        double distance = Math.sqrt(distance3);
        return distance;
    }
